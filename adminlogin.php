...
<script type="text/javascript">
    ...
    <body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="top-navbar-1">
					<ul class="nav navbar-nav navbar-right">						
						...
						<li class="active">
							<a href="adminlogin.php"><span aria-hidden="true" class="icon_camera"></span><br>Login</a>
						</li>
	    ...
	    <h3 align="center">Faculty  Login <a href="facultylogin.php">Click here</a> </h3>
		    <div class="container">
	            <div class="row">
...
<tr>
<th colspan="3" bgcolor="#FFFFFF"><h1 class="style1">Admin Login </h1></th>
</tr>
<tr>
