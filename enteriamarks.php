	...
	if (isset($_SESSION['username'])) 
{
	...
	$sname = $_POST['studentname'];
		...
		$sql = "insert into iamarks values('$name',1,1,$status)";
	...
	$sname = $_POST['studentname'];
		...
		echo '<br/>firstUSN->'.$name;
		echo '<br/>firstStat->'.$status;
		$sql = "insert into iamarks values('$name',1,2,$status)";
		$result=mysql_query($sql) or trigger_error(mysql_error().$sql);
		//echo 'i:</br>'.$icount;
		//echo  'j:</br>'.$jcount;
		if($result)
	...
	$sname = $_POST['studentname'];
		...
		echo '<br/>firstUSN->'.$name;
		echo '<br/>firstStat->'.$status;
		$sql = "insert into iamarks values('$name',1,3,$status)";
		$result=mysql_query($sql) or trigger_error(mysql_error().$sql);
		//echo 'i:</br>'.$icount;
		//echo  'j:</br>'.$jcount;
		if($result)
	...
	$sname = $_POST['studentname'];
		...
		echo '<br/>firstUSN->'.$name;
		echo '<br/>firstStat->'.$status;
		$sql = "insert into iamarks values('$name',1,4,$status)";
		$result=mysql_query($sql) or trigger_error(mysql_error().$sql);
		//echo 'i:</br>'.$icount;
		//echo  'j:</br>'.$jcount;
		if($result)
	...
	$sname = $_POST['studentname'];
		...
		echo '<br/>firstUSN->'.$name;
		echo '<br/>firstStat->'.$status;
		$sql = "insert into iamarks values('$name',1,5,$status)";
		$result=mysql_query($sql) or trigger_error(mysql_error().$sql);
		//echo 'i:</br>'.$icount;
		//echo  'j:</br>'.$jcount;
		if($result)
...
<td align="center" valign="middle" bordercolor="#00FF00" bgcolor="#FFFFFF">
<input name="Submitfour" type="submit" class="style1" value="Update I A 4 Marks" /></td>
<td align="center" valign="middle" bordercolor="#00FF00" bgcolor="#FFFFFF">
<input name="Submitfive" type="submit" class="style1" value="Update Special IA Marks" /></td>
