	...
	$sname = $_POST['studentname'];
		...
		$q22="SELECT * FROM student where usn='$name' ";
					...
					while($res=mysql_fetch_array($r22)){
					 $number=$res[5];
					 echo $number;
					 $message="Your IA MArks is  test name is:".$status;
...
<td bgcolor="#FFFFFF"> <?php
					...
					if ($un!=null)
					{
					$q2="SELECT * FROM iamarks WHERE  iamarks.scode='$scode' and branch='$branch' and usn='$un'  ";
					...
					echo "<td>".$rs[3]."<input type='text' /td></br>";
						echo "<td>".$rs[4]."<input type='text' name='ia[]' /td></br>";
